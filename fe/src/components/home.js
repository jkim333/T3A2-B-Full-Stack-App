...
const Home = () => {
  return (
    <div className="w-screen h-screen overflow-hidden box-border  bg-gradient-to-b from-blue-900 to-sky-800">
      ...
      <Link className="bg-sky-800 text-blue-200 rounded-full px-16 py-2  mt-20 my-auto " to="/login">Login</Link>
      <Link className="bg-sky-800 text-blue-200 rounded-full px-14 py-2  mt-20 ml-5 my-auto "  to="/signup">Sign up</Link>
      </div>
